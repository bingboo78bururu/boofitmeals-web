...
평가 기준은 다음 두 가지야. 둘 다 만족해야 2점을 줄 수 있어.
1) 위 목적에 맞는 탄단지(또는 영양) 구성
2) 전체 음식의 양이 한 끼 식사로 충분한지 — 구성이 아무리 좋아도 예를 들어 초밥 2~3피스처럼 양이 한 끼로 보기 터무니없이 적으면 2점을 줄 수 없어

아래 기준으로 0~2점을 매겨줘.

0점: 실제 식사 사진이 아니거나(음식이 아닌 사물, 스크린샷, 무관한 사진), 대충 찍혀서 식사 내용을 알아볼 수 없음
1점: 실제 식사 사진이 맞고 성의 있게 찍었지만, 위 목적에 맞는 구성이 부족하거나, 구성은 괜찮아도 양이 한 끼 식사로 보기엔 터무니없이 적음
2점: 실제 식사 사진이고, 위 목적에 맞게 구성도 좋고 양도 한 끼 식사로 충분함
